...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    affiliations: Schema.Attribute.Text
    author_aff: Schema.Attribute.Text
    authors: Schema.Attribute.Text
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private
    disciplineAbbr: Schema.Attribute.String
    doi_final: Schema.Attribute.String
    doi_WOS: Schema.Attribute.String
    ft50: Schema.Attribute.Boolean
    ISSN: Schema.Attribute.String
    journalAbbr: Schema.Attribute.String
    journalFullName: Schema.Attribute.String & Schema.Attribute.Required
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<
      "oneToMany",
      "api::article.article"
    > &
      Schema.Attribute.Private
    openalex_article_url: Schema.Attribute.String
    openalex_doi: Schema.Attribute.String
    ...
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private
    utd24: Schema.Attribute.Boolean
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private
    orcidId: Schema.Attribute.String &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 19
        minLength: 19
    ...
    role: Schema.Attribute.Relation<
      ...
      "plugin::users-permissions.role"
    >
    scopusId: Schema.Attribute.String &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 11
        minLength: 10
