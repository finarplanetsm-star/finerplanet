...
import { apiClient } from "@/api/lib/lib/apiClient" // Ensure this client sends the 'Authorization: Bearer' header!
...
const CommentSchema = Yup.object().shape({
  ...
  content: Yup.string().trim().required("Comment/Correction is required"),
...
const CommentSection = ({ blogId }: CommentSectionProps) => {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 px-4 md:px-0">
      ...
      {/* --- Submission Form --- */}
      <div className="bg-[#F8F9FA] p-6 md:p-8 rounded-xl border border-gray-200">
            ...
            <Form className="space-y-5">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full md:w-auto bg-[#3B3098] text-white px-8 py-3 rounded-md font-bold hover:bg-[#2a226b] disabled:opacity-50 transition-all shadow-md cursor-pointer"
                >
